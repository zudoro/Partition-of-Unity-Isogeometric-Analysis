...
!   GLOBAL PARAMETER
	...
	REAL*8, PARAMETER :: EPSLN = 0.0001d0
	REAL*8, PARAMETER :: SIGMA = 0.650D0
	
	REAL*8, PARAMETER :: ALPHA = 3.0D0/8.0D0
	REAL*8, PARAMETER :: BETA = 5.0D0/8.0D0
	REAL*8, PARAMETER :: GAMMA = 0.50D0

	REAL*8, DIMENSION(1:2), PARAMETER :: DELTA = (/0.10D0, 0.10D0/)
	
	REAL*8, PARAMETER :: KAPPA = 0.50D0

	REAL*8, DIMENSION(1:2), PARAMETER :: RADIUS = (/0.50D0, 2.0D0/)

	INTEGER, DIMENSION(1:2), PARAMETER :: NUMPATCH = (/1,4/)
